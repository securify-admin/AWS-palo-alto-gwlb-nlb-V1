...
variable "security_vpc_lb_subnet_cidrs" {
  description = "CIDR blocks for load balancer subnets in Security VPC"
  type        = list(string)
...
variable "security_vpc_gwlb_subnet_cidrs" {
  ...
  type        = list(string)
  default     = ["10.48.76.224/29", "10.48.76.232/29"]
}

variable "security_vpc_firewall_public_subnet_cidrs" {
  description = "CIDR blocks for firewall and gateway public interfaces in Security VPC"
  type        = list(string)
...
variable "security_vpc_tgw_attachment_subnet_cidrs" {
  ...
  type        = list(string)
  default     = ["10.48.76.128/29", "10.48.76.136/29"]
}
...
variable "security_vpc_gwlbe_dedicated_subnet_cidrs" {
  ...
  type        = list(string)
  default     = ["10.48.76.192/29", "10.48.76.200/29"]
}
